...
export default function BlogComment({
  ...
  return (
    <Section className="mt-6 py-10 px-4 gap-4 bg-white dark:bg-black border border-red-50 dark:border-gray-800 max-w-[600px]">
      <h1 className="font-cursive text-4xl mb-4 dark:text-gray-200">
        {heading}
      </h1>
      ...
      >
        ...
        <Button
          ...
          disabled={disabled}
          className="border dark:border-gray-800 bg-transparent border-red-50 my-4 py-3 bg-orange-500"
        >
          {
            btnText
            // ? btnText : "submit"
