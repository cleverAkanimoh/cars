  ...
  return (
    <>
      <Image
        src={bgImage}
        alt={"background"}
        className="fixed top-0 left-0 -z-[9999] w-screen h-screen opacity-5"
        priority
      />
      ...
      <footer className="w-full relative flex flex-col gap-4 items-center justify-center py-6 md:py-8 my-10 sm:my-0 text-slate-300 text-lg px-2">
          ...
          <aside className="flex flex-wrap gap-6">
            ...
            <div className="flex flex-wrap gap-4">
              <FooterLinks
                heading={"services"}
                links={[
                  { title: "rent", href: `listings?flag=rent` },
                  { title: "sell", href: `listings?flag=sell` },
                  { title: "buy", href: `listings?flag=buy` },
              ...
              <FooterLinks
                ...
                links={[
                  ...
                  { title: "Terms and Conditions", href: `privacy/#terms` },
                ]}
              />
              <FooterLinks
                heading={"support"}
              ...
              <FooterLinks
                ...
                links={[
                  {
                    title: "Facebook",
                    href: `https://www.facebook.com/carsinn`,
                  },
                  {
                    title: "Instagram",
                    href: `https://www.instagram.com/carsinn`,
                  },
                  { title: "Twitter/X", href: `https://www.x.com/carsinn` },
                ]}
              />
            </div>
          </aside>
        ...
        <Section className="bg-red-950 justify-center">
          <p className="text-sm text-center sm:text-[0.90rem] font-semibold">
        ...
        <button
          ...
          } fixed bottom-4 right-4 bg-orange-500 bg-opacity-50 hover:bg-opacity-100 text-white p-3 rounded-full z-[10000] outline-0 transition-all duration-300`}
        >
          <BsArrowBarUp className="text-2xl sm:text-xl" />
        </button>
      </footer>
    </>
  );
